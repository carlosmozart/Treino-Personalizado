...
### Notas
- Auditoria de CSS nao utilizado refeita: 50 classes sem referencia, somando **2,8 KB de
  39,8 KB**. Numero pequeno demais para justificar a remocao manual, entao nada foi mexido
- `CACHE_NAME`: `treino-cache-v29` -> `treino-cache-v30`
